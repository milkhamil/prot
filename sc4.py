...
cl = KITSUNEBOT.LINE()
cl.login(token="Ek4EnQIbtkukZiTd4y4e.1MqsifIP5GD8k+2XnfZcVG.S3Lx53bR5EPVuP+6wIBnKrffcCfVeIIoou3hDHAqK58=")
cl.loginResult()

ki = KITSUNEBOT.LINE()
ki.login(token="Ekb64jB73ZNKKq1I2907.dpPsok9SDpuNxns2D6AZrW.nLdrfrBx7CHxhkORDbjwzjeYDp4oQjsmZRhvfweSECA=")
ki.loginResult()
reload(sys)
