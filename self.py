    ...
    try:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                msg.text = None
                ki.sendMessage(msg)
            elif msg.text in ["Gift","Lagi baek"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': '3b92c8f5-54d3-4765-848f-c9ffdc1da020',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '8'}
                msg.text = None
                cl.sendMessage(msg)
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"URL close")
            elif msg.text.lower() == 'Invgcreator':
                if msg.toType == 2:
            ...
            elif "All bio " in msg.text:
                string = msg.text.replace("All bio ","")
...
#--------------------------------------------------------
                ...
                if wait["commentOn"] == True:
                    ...
                    wait["commentOn"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"AutoComment set to on")
                    else:
                        cl.sendText(msg.to,"è¦äº†å¼€👈")
            elif msg.text in ["Comment off"]:
                if wait["commentOn"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"AutoComment is already off")
                    else:
                        cl.sendText(msg.to,"AutoComment is already off")
                else:
                    wait["commentOn"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"AutoComment set to off")
                    else:
                        cl.sendText(msg.to,"AutoComment set to off")
