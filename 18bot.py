...
cl = LINETCR.LINE()
cl.login(token="EmdhD80DPHNM0ZGrA4bc.t/tzrTvswcgHFrUhFx7BFa.FpiT5RxoUACFPp5yuf5N5MwZ4oEWWi3Dpd8+ugnzlHc=")
cl.loginResult()
...
ki15 = LINETCR.LINE()
ki15.login(token="EmT0zNpQRmr9Knh9qnA5.r5ASasddV+NqkdGxLRGGHq.ItRb5mu5Z7HUJ6km/EHJNhDkgwyE4mEYCynq5CpGmbI=")
ki15.loginResult()
...
#--------------------------------------------------------
                ...
                if wait["protect"] == True: md+="􀐂􀇰pin􏿿 Protect:on 􀜁􀄯􏿿\n"
                else:md+="􀐂􀇰pin􏿿 Protect:off 􀜁􀄰􏿿\n"
                if wait["linkprotect"] == True: md+="􀐂􀇰pin􏿿 Proqr:on 􀜁􀄯􏿿\n"
                else:md+="􀐂􀇰pin􏿿 Link Protect:off 􀜁􀄰􏿿\n"
                if wait["inviteprotect"] == True: md+="􀐂􀇰pin􏿿 Proinvite:on 􀜁􀄯􏿿\n"
                else:md+="􀐂􀇰pin􏿿 Invitation Protect:off 􀜁􀄰􏿿\n"
                if wait["cancelprotect"] == True: md+="􀐂􀇰pin􏿿 Procancel:on 􀜁􀄯􏿿\n"
                else:md+="􀐂􀇰pin􏿿 Cancel:off 􀜁􀄰􏿿\n"
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    random.choice(klist).kickoutFromGroup(msg.to,[target])
                                    print (msg.to,[g.mid])
                                except:
...
#			    random.choice(klist).kickoutFromGroup(op.param1,[op.param2])
	...
	if op.type == 13:
		...
		if op.param2 in Bots:
		    ...
		    wait ["blacklist"][op.param2] = True
		    random.choice(klist).cancelGroupInvitation(op.param1,[op.param3])
		else:
		    cl.sendText(op.param1,"")
	    else:
		cl.sendText(op.param1,"")
