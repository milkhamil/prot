		  ...
		  if msg.from_ in admin:
            	      if msg.toType == 2:
                  	  print "ok"
                    	  ...
                    	  ki.sendText(msg.to,"Bukan pembantu tapii doyan bersih bersih")
                    	  kc.sendText(msg.to,"sorry ya GO-CLEAN  numpang lewat")
                   	  targets = []
                    	  for g in gs.members:
                          ...
                          for target in targets:
                              try:
                                  ...
                                  ki.sendText(msg.to,"Group udah di bersihin bos")
                                  kk.sendText(msg.to,"Group udah di bersihin bos")
                                  kc.sendText(msg.to,"Group udah di bersihin bos")
#-------------- fungsi nk----------------
            elif "Nk " in msg.text:
                  if msg.from_ in admin:
