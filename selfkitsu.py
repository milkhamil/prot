...
cl = KITSUNEBOT.LINE()
cl.login(token="EkOfaBLUVE3ItDceVdL5.gZZJX7/7XFs18VBE0wUJPq.GXafP3x4VpWtK0v3XxAHSvZVuuPirT0b/gZzKek2eY0=")
cl.loginResult()

ki = KITSUNEBOT.LINE()
ki.login(token="EkPSs48boyWSwTGdbfS0./OC+xvnbFbckR10ApfYlqa.sqtKEn9LCcfFTKqsj5RfF9mYasBDiza3VrO5sgJgSwg=")
ki.loginResult()

ki2 = KITSUNEBOT.LINE()
ki2.login(token="Ek6mbhQDp5PudrUFu9fa.WhVNbv37cyEKQRfeI86awG.JIzPKnpdkNgux04Q3h7TUeRe9Nf5hssisRD7YTAvf2I=")
ki2.loginResult()

ki3 = KITSUNEBOT.LINE()
ki3.login(token="Ek15EUCXwWVfWFOq83x0.jMNAFXCzNf1IBajnFsOB4a.eLur2KZChiyBcVn4ms1hyKI2scexP/870h9GXBdAblo=")
ki3.loginResult()
...
helpMessage ="""       Self Bots Command ᴿᴱ:ᴋɪ͜͡ᴛsᴜ͜͡ɴᴇʙ͜͡ᴏᴛ
...
􀜁􀇔􏿿 Bye all        
   ...
   􀜁􀇔􏿿 http://line.me/ti/p/fcimicrosoftaditya 􀜁􀇔􏿿
"""
helo=""
...
🤖Open Admin Bot Protect kasem:
🔹10 Bots 500k
🔹5 Bots 250k

🏄Open Staff Bot Protect Kasem:
🔸10 Bots 250k
🔸5 Bots 150k
🔸10 Bots Untuk 5 Orang Menjadi Staff 750k
🔸5 Bots Untuk 5 Orang Menjadi Staff 450k

🏖Sewa untuk jaga group:
🏈10 Bots 100k Untuk 2 Groups
⚾10 Bots 85k Untuk 1 Group
🎱5 Bots 60k Untuk 2 Groups
🎳5 Bots 50k Untuk 1 Group
🎆3 Bots 35k Untuk 2 Groups
🎄3 Bots 30k Untuk 1 Group
